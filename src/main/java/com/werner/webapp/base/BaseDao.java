...
//    void saveOrUpdate(Object entity);
     ...
     *
     * @param queryString 查询语句
     * @param pageIndex   当前页码，如果pageIndex<1则不分页，且返回pageSize条记录。
     * @param pageSize    每页记录数，如果pageSize<1则返回所有记录。
     * @param params      可选的查询参数
     * @return 实体分页对象
     */
    @SuppressWarnings("hiding")
     ...
     * @param queryString 查询语句
     * @param params      可选的查询参数
     * @param pageIndex   当前页码，如果pageIndex<2则不分页，且返回pageSize条记录。
     * @param pageSize    每页记录数，如果pageSize<1则返回所有记录。
     * @return 实体分页对象
     */
    @SuppressWarnings("hiding")
